...
<body>
    <div class="contact-us-container" id="Contact_Us">
        ...
        <div class="contact-us-text"><span>Contact&nbsp;</span>Us</div>
        <div class="visit-us-container">
            <div class="visit-us-text">Visit Us</div>
            <div class="visit-us-box">
                <div class="visit-us-details"><img src="assets/img/location-marker-small.png" alt="location-marker-small.png">&nbsp;Lee Summit, Kansas City, USA</div>
                <img src="assets/img/location-map.png" alt="location-map.png" class="location-map">
            </div>
        </div>

        <div class="pitch-us-container">
            <div class="pitch-us-text">Pitch Us</div>
            <div class="pitch-us-box">
                <img src="assets/img/whatsapp.png" alt="whatsapp.png" class="whatsapp">
                <div class="pitch-us-details">+1 996 656 2355</div>
            </div>
        </div>

        <div class="send-us-container">
            <div class="send-us-text">Send Us A Message</div>
            <div class="send-us-box">
                <img src="assets/img/gmail.png" alt="gmail.png" class="gmail-icon">
                <a href="#gmail" class="gmail-email">info@dreambite.com</a>
                <br>
                <img src="assets/img/facebook-icon.png" alt="facebook-icon.png" class="facebook-icon">
                <a href="#facebook" class="fb-contact">Dreambite Dental Clinic Official</a>
            </div>
        </div>  
